...
class ButtonActionRecorder
{
public:
    static void recordButtonAction(const QString& action)
    {
...
private slots:
    ...
    void on_btn_histor_to_dash_clicked();


    void on_generate_btn_clicked();

    void on_pwd_generator_btn_clicked();

    void on_back_pwd_clicked();

    void on_btn_generate_clicked();

    void on_pwd_generator_btn_2_clicked();

    void on_btn_back_pwd_clicked();
...
private:
    ...
    QString apikey = "eyJ2ZXIiOiIxLjAiLCJ0eXAiOiJKV1QiLCJhbGciOiJFUzM4NCIsImtpZCI6ImRzRUN2TDVaTENQbTl1R081RHltUjZCRTdMcnFGak5hX1VKbl9Ody1zdVUifQ..EcrwZ51gcKOOu3T5r4TtPVsPmkEFj8FTuwBW4kgfrQ3n6yg4XVhhSO6FodRw9IHQVRdpfc6JrUGO-QLT_4VUyLPNWZw4M9YMgIRMaoxkyMk_Q2Xmwcra0rTWYfUFHgw_";
};
#endif // MAINWINDOW_H
